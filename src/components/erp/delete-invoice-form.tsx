...
export function DeleteInvoiceForm({ invoiceId, action }: DeleteInvoiceFormProps) {
  ...
  const handleDelete = async () => {
    try {
      ...
      toastMessages.success(
        "Factura eliminada",
        "La factura ha sido eliminada exitosamente"
      );
    } catch (error) {
      toastMessages.error(
        "Error al eliminar",
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        description="Esta acción no se puede deshacer. La factura será eliminada permanentemente del sistema."
